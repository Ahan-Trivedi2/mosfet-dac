...
N 440 -70 490 -70 {lab=Idump}
N 440 -130 490 -130 {lab=#net2}
N 280 -270 280 -230 {lab=Iprime}
N 220 -270 220 -230 {lab=Iin}
N 410 -100 460 -100 {lab=#net1}
N 250 -240 250 -200 {lab=Vgate}
N 190 -230 190 -210 {lab=Iin}
N 190 -150 190 -140 {lab=#net2}
N 120 -180 160 -180 {lab=Vgate}
N 190 -140 190 -130 {lab=#net2}
N 150 -70 190 -70 {lab=Iout}
N 120 -100 160 -100 {lab=D}

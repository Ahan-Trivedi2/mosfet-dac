...
N -860 120 -820 120 {lab=b0}
N -1030 180 -990 180 {lab=Vout}
N -1000 150 -990 150 {lab=VN}
N -1030 150 -1000 150 {lab=VN}
N -1030 120 -990 120 {lab=VP}
N -1030 210 -990 210 {lab=Vg}
N -860 150 -820 150 {lab=b1}
N -860 180 -820 180 {lab=b2}
N -860 210 -820 210 {lab=b3}
N -860 240 -820 240 {lab=b4}
N -860 270 -820 270 {lab=b5}
N -860 300 -820 300 {lab=b6}
N -1030 240 -990 240 {lab=Res}
N -550 20 -460 20 {lab=#net3}
N -520 -250 -490 -250 {lab=Vg}
N -520 -280 -520 -250 {lab=Vg}
N -460 -280 -450 -280 {lab=#net4}
N -530 -280 -520 -280 {lab=Vg}
N -450 -250 -420 -250 {lab=#net4}
N -450 -280 -450 -250 {lab=#net4}
N -700 200 10 200 {lab=VN}
N -700 160 10 160 {lab=Vg}
N 10 160 140 160 {lab=Vg}
N 10 200 140 200 {lab=VN}
N -390 -280 -390 -250 {lab=VN}
N -590 -280 -590 -250 {lab=VP}
N -520 -340 -490 -340 {lab=Vg}
N -520 -370 -520 -340 {lab=Vg}
N -460 -370 -450 -370 {lab=#net4}
N -530 -370 -520 -370 {lab=Vg}
N -450 -340 -420 -340 {lab=#net4}
N -450 -370 -450 -340 {lab=#net4}
N -390 -370 -390 -340 {lab=VN}
N -390 -340 -390 -280 {lab=VN}
N -450 -340 -450 -280 {lab=#net4}
N -520 -340 -520 -280 {lab=Vg}
N -590 -370 -590 -280 {lab=VP}
N -560 -340 -560 -240 {lab=Vbp}
N -290 -250 -260 -250 {lab=Vg}
N -260 -280 -260 -250 {lab=Vg}
N -330 -280 -320 -280 {lab=#net4}
N -260 -280 -250 -280 {lab=Vg}
N -360 -250 -330 -250 {lab=#net4}
N -330 -280 -330 -250 {lab=#net4}
N -190 -280 -190 -250 {lab=VP}
N -290 -340 -260 -340 {lab=Vg}
N -260 -370 -260 -340 {lab=Vg}
N -330 -370 -320 -370 {lab=#net4}
N -260 -370 -250 -370 {lab=Vg}
N -360 -340 -330 -340 {lab=#net4}
N -330 -370 -330 -340 {lab=#net4}
N -330 -340 -330 -280 {lab=#net4}
N -260 -340 -260 -280 {lab=Vg}
N -190 -370 -190 -280 {lab=VP}
N -220 -340 -220 -240 {lab=Vbp}
N -490 -250 -490 -210 {lab=Vg}
N -490 -210 -260 -210 {lab=Vg}
N -260 -250 -260 -210 {lab=Vg}
N -220 -240 -220 -200 {lab=Vbp}
N -560 -200 -220 -200 {lab=Vbp}
N -560 -240 -560 -200 {lab=Vbp}
N -590 -250 -590 -160 {lab=VP}
N -590 -160 -190 -160 {lab=VP}
N -190 -250 -190 -160 {lab=VP}
N -450 -250 -450 -230 {lab=#net4}
N -330 -250 -330 -230 {lab=#net4}
N -450 -230 -330 -230 {lab=#net4}
...
C {lab_pin.sym} -820 120 2 0 {name=p9 sig_type=std_logic lab=b0}
C {lab_pin.sym} -990 150 2 0 {name=p27 sig_type=std_logic lab=VN
}
C {lab_pin.sym} -990 120 2 0 {name=p28 sig_type=std_logic lab=VP
}
C {lab_pin.sym} -990 180 2 0 {name=p32 sig_type=std_logic lab=Vout
}
C {iopin.sym} -1030 120 2 0 {name=p33 lab=VP}
C {iopin.sym} -1030 150 2 0 {name=p34 lab=VN}
C {opin.sym} -1030 180 2 0 {name=p35 lab=Vout}
C {ipin.sym} -860 120 0 0 {name=p36 lab=b0}
C {lab_pin.sym} -990 210 2 0 {name=p37 sig_type=std_logic lab=Vg
}
C {opin.sym} -1030 210 2 0 {name=p38 lab=Vg}
C {ipin.sym} -860 150 0 0 {name=p40 lab=b1}
C {ipin.sym} -860 180 0 0 {name=p42 lab=b2}
C {ipin.sym} -860 210 0 0 {name=p44 lab=b3}
C {ipin.sym} -860 240 0 0 {name=p46 lab=b4}
C {ipin.sym} -860 270 0 0 {name=p48 lab=b5}
C {ipin.sym} -860 300 0 0 {name=p50 lab=b6}
C {lab_pin.sym} -820 150 0 1 {name=p39 sig_type=std_logic lab=b1}
C {lab_pin.sym} -820 180 0 1 {name=p41 sig_type=std_logic lab=b2}
C {lab_pin.sym} -820 210 0 1 {name=p43 sig_type=std_logic lab=b3}
C {lab_pin.sym} -820 240 0 1 {name=p45 sig_type=std_logic lab=b4}
C {lab_pin.sym} -820 270 0 1 {name=p47 sig_type=std_logic lab=b5}
C {lab_pin.sym} -820 300 0 1 {name=p49 sig_type=std_logic lab=b6}
C {lab_pin.sym} -990 240 2 0 {name=p52 sig_type=std_logic lab=Res
}
C {opin.sym} -1030 240 2 0 {name=p53 lab=Res}
...
C {madvlsi/nmos3.sym} -420 -280 3 0 {name=M2
L=1
W=1
body=VN
nf=1
...
C {madvlsi/nmos3.sym} -490 -280 3 0 {name=M4
L=1
W=1
body=VN
nf=1
...
C {lab_pin.sym} -590 -160 3 0 {name=p59 sig_type=std_logic lab=VP}
C {lab_pin.sym} -560 -200 3 0 {name=p56 sig_type=std_logic lab=Vbp}
C {lab_pin.sym} -520 -250 3 0 {name=p2 sig_type=std_logic lab=Vg
}
...
C {madvlsi/nmos3.sym} -420 -370 3 0 {name=M5
L=1
W=1
body=VN
nf=1
...
C {madvlsi/nmos3.sym} -490 -370 3 0 {name=M7
L=1
W=1
body=VN
nf=1
...
C {madvlsi/nmos3.sym} -360 -280 1 1 {name=M8
L=1
W=1
body=VN
nf=1
...
C {madvlsi/nmos3.sym} -290 -280 1 1 {name=M10
L=1
W=1
body=VN
nf=1
...
C {madvlsi/nmos3.sym} -360 -370 1 1 {name=M11
L=1
W=1
body=VN
nf=1
...
C {madvlsi/nmos3.sym} -290 -370 1 1 {name=M13
L=1
W=1
body=VN
nf=1
